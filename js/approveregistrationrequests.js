$(document).ready(function() {
    ...
    var gpid = (new URL(location.href)).searchParams.get('gpid');
    console.log(gpid);

    var currentcapacity = parseInt((new URL(location.href)).searchParams.get('capacity'))+1;
    ...
    $.Toast("Failure!","Error in retrieving the registration details", "error", options); 
    }
    else {
    ...
    //return response.json();
            ...
            $("#approveRegistration").click(function() {
                ...
                fetch("http://localhost:8081/api/v1/GPs/currentcapacity/" + gpid, {
                method: "put",
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
                ...
                $.Toast("Success!","You have approved the GP Registration request", "success", options);
                setTimeout(function () {
